...
With this command, score/profile_length(or slen) > 300 may be homologous proteins. (Using the same options and same representations. Assumed from small experiments & no statistical evidence.) 
