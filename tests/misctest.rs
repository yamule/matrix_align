...
mod tests{
    ...
    fn aligntest(){
        ...
        for ii in 0..num_iter{
            ...
            let mut saligner:ProfileAligner = ProfileAligner::new(veclen,200,Some(-10.0),Some(-0.5),AlignmentType::Global,matrix_align::aligner::ScoreType::DistanceZscore,None
            ,true);
    ...
    fn hierarchical_aligntest(){
        ...
        let veclen = gmat1_[0].2[0].len();
        let mut saligner:ProfileAligner = ProfileAligner::new(veclen,200,Some(-10.0), Some(-0.5),AlignmentType::Global,matrix_align::aligner::ScoreType::DistanceZscore,None,true);
        let mut seqvec:Vec<SequenceProfile> = vec![];
